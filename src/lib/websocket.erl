...
-export([get_handshake/4, get_handshake/5, check_handshake/2, encode_binary/1, encode_text/1,
...
get_handshake(Host, Path, SubProtocol, Version, Headers) ->
  %TODO
  {Key, Accept} = gen_accept_key(),
  Req = list_to_binary(["GET ", Path, " HTTP/1.1\r\n",
    "Host: ", Host, "\r\n",
    ...
    "Origin: http://", Host, "\r\n",
    "Sec-WebSocket-Version: ", Version, "\r\n",
    ts_http_common:headers(Headers),
    ?CRLF
  ]),
  SubProHeader = case SubProtocol of
                   [] -> [];
